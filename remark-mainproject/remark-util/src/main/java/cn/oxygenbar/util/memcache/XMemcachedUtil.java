...
public class XMemcachedUtil {
    ...
    public static Object[] getMultiArray(String[] keys) {
        try {
            ...
            Logs.geterrorLogger().error("getMultiArray ERROR: keys=" + tmp_key, e);
            return null;
        }
    }
...
class LocalCache {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(XMemcachedUtil.get("lei_test001"));
    	...
    	//[{btc_okcoin_usd=643.8}, {btc_bitfinex=646.62}, {btc_coinbase=650.52}, {btc_bitstamp=646.26}]
//    	try {
//    		Thread.sleep(30000);
//		} catch (Exception e) {
